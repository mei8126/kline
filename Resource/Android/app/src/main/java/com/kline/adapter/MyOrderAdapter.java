...
import com.kline.R;
import com.kline.bean.Order;
import com.kline.bean.OrderItem;
 ...
 */
public class MyOrderAdapter  extends SimpleRecyclerBaseAdapter<Order> {
    ...
    @Override
    public void bindDatas(RecyclerViewBaseViewHolder holder, Order order) {
